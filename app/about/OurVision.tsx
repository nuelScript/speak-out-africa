...
const OurVision = () => {
  return (
    <div className="flex w-full flex-col gap-10 bg-gray-400 px-10 py-9 xl:flex-row xl:px-20 xl:py-20">
      <div className="flex w-full justify-center xl:w-1/2">
        <h1 className="text-4xl font-bold uppercase xl:text-6xl">Our Vision</h1>
      </div>
